...
COption::SetOptionString("aspro.allcorp", "USE_CAPTCHA_FORM", "NONE", "", WIZARD_SITE_ID);
...
COption::SetOptionString("aspro.allcorp", "FILTER_VIEW", "VERTICAL", "", WIZARD_SITE_ID);
COption::SetOptionString("aspro.allcorp", "DISPLAY_PROCESSING_NOTE", "N", "", WIZARD_SITE_ID);
COption::SetOptionString("aspro.allcorp", "BIGBANNER_ANIMATIONTYPE", "SLIDE_HORIZONTAL", "", WIZARD_SITE_ID);
COption::SetOptionString("aspro.allcorp", "BIGBANNER_SLIDESSHOWSPEED", "5000", "", WIZARD_SITE_ID);
COption::SetOptionString("aspro.allcorp", "BIGBANNER_ANIMATIONSPEED", "600", "", WIZARD_SITE_ID);
COption::SetOptionString("aspro.allcorp", "BIGBANNER_HIDEONNARROW", "N", "", WIZARD_SITE_ID);
COption::SetOptionString("aspro.allcorp", "PARTNERSBANNER_SLIDESSHOWSPEED", "5000", "", WIZARD_SITE_ID);
COption::SetOptionString("aspro.allcorp", "PARTNERSBANNER_ANIMATIONSPEED", "600", "", WIZARD_SITE_ID);
COption::SetOptionString("aspro.allcorp", "USE_YA_COUNTER", "N", "", WIZARD_SITE_ID);
COption::SetOptionString("aspro.allcorp", "USE_FORMS_GOALS", "COMMON", "", WIZARD_SITE_ID);
COption::SetOptionString("aspro.allcorp", "USE_DEBUG_GOALS", "N", "", WIZARD_SITE_ID);
