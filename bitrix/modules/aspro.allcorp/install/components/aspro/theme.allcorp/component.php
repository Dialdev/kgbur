...
aspro::getParam($arResult, "use_captcha_form");
aspro::getParam($arResult, "display_processing_note");
aspro::getParam($arResult, "partnersbanner_slidesshowspeed");
aspro::getParam($arResult, "partnersbanner_animationspeed");
aspro::getParam($arResult, "bigbanner_hideonnarrow");
aspro::getParam($arResult, "bigbanner_slidesshowspeed");
aspro::getParam($arResult, "bigbanner_animationspeed");
aspro::getParam($arResult, "bigbanner_animationtype");
...
$arTheme = array(
	...
	"USE_CAPTCHA_FORM" => $arResult["USE_CAPTCHA_FORM"]["CURRENT"],
	"DISPLAY_PROCESSING_NOTE" => $arResult["DISPLAY_PROCESSING_NOTE"]["CURRENT"],
	"PARTNERSBANNER_SLIDESSHOWSPEED" => $arResult["PARTNERSBANNER_SLIDESSHOWSPEED"]["CURRENT"],
	"PARTNERSBANNER_ANIMATIONSPEED" => $arResult["PARTNERSBANNER_ANIMATIONSPEED"]["CURRENT"],
	"BIGBANNER_HIDEONNARROW" => $arResult["BIGBANNER_HIDEONNARROW"]["CURRENT"],
	"BIGBANNER_SLIDESSHOWSPEED" => $arResult["BIGBANNER_SLIDESSHOWSPEED"]["CURRENT"],
	"BIGBANNER_ANIMATIONSPEED" => $arResult["BIGBANNER_ANIMATIONSPEED"]["CURRENT"],
	"BIGBANNER_ANIMATIONTYPE" => $arResult["BIGBANNER_ANIMATIONTYPE"]["CURRENT"],
);
?>
...
arAllcorpOptions['THEME']['USE_CAPTCHA_FORM'] = '<?=$arResult["USE_CAPTCHA_FORM"]["CURRENT"]?>';
arAllcorpOptions['THEME']['DISPLAY_PROCESSING_NOTE'] = '<?=$arResult["DISPLAY_PROCESSING_NOTE"]["CURRENT"]?>';
arAllcorpOptions['THEME']['PARTNERSBANNER_SLIDESSHOWSPEED'] = '<?=$arResult["PARTNERSBANNER_SLIDESSHOWSPEED"]["CURRENT"]?>';
arAllcorpOptions['THEME']['PARTNERSBANNER_ANIMATIONSPEED'] = '<?=$arResult["PARTNERSBANNER_ANIMATIONSPEED"]["CURRENT"]?>';
arAllcorpOptions['THEME']['BIGBANNER_HIDEONNARROW'] = '<?=$arResult["BIGBANNER_HIDEONNARROW"]["CURRENT"]?>';
arAllcorpOptions['THEME']['BIGBANNER_SLIDESSHOWSPEED'] = '<?=$arResult["BIGBANNER_SLIDESSHOWSPEED"]["CURRENT"]?>';
arAllcorpOptions['THEME']['BIGBANNER_ANIMATIONSPEED'] = '<?=$arResult["BIGBANNER_ANIMATIONSPEED"]["CURRENT"]?>';
arAllcorpOptions['THEME']['BIGBANNER_ANIMATIONTYPE'] = '<?=$arResult["BIGBANNER_ANIMATIONTYPE"]["CURRENT"]?>';
