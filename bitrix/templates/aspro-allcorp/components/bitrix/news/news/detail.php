...
$arElement = CCache::CIblockElement_GetList(array("CACHE" => array("TAG" => CCache::GetIBlockCacheTag($arParams["IBLOCK_ID"]), "MULTI" => "N")), $arItemFilter, false, false, array("ID", 'PREVIEW_TEXT', "IBLOCK_SECTION_ID", 'PREVIEW_PICTURE', 'DETAIL_PICTURE', "PROPERTY_LINK_PROJECTS", "PROPERTY_LINK_GOODS", "PROPERTY_LINK_REVIEWS", "PROPERTY_LINK_STAFF", "PROPERTY_LINK_SERVICES"));
