...
<html xml:lang="<?=LANGUAGE_ID?>" lang="<?=LANGUAGE_ID?>" class="<?=($_SESSION['SESS_INCLUDE_AREAS'] ? 'bx_editmode' : '')?><?=(strpos($_SERVER['HTTP_USER_AGENT'], 'MSIE 7.0') ? ' ie ie7' : '')?> <?=(strpos($_SERVER['HTTP_USER_AGENT'], 'MSIE 8.0') ? ' ie ie8' : '')?><?=(strpos($_SERVER['HTTP_USER_AGENT'], 'MSIE 9.0') ? ' ie ie9' : '')?>">
	<head>
		...
		<meta name="yandex-verification" content="0e717ffdc11dd2d0" />
					...
					<div class="row">
						<div class="col-md-12">
							<div class="row info-head">
								<div class="<? /* col-lg-6 col-md-5|col-lg-9 col-md-9 */ ?> col-md-12">
									<div class="info-text">
										<div class="email">
										...
										<div class="skype hidden-xs">
											...
											<?$APPLICATION->IncludeFile(SITE_DIR."include/site-address-header.php", array(), array(
													"MODE" => "html",
													"NAME" => "Address",
												)
											);?>
										...
										<div class="time">										
											<?$APPLICATION->IncludeFile(SITE_DIR."include/site-time.php", array(), array(
													"MODE" => "html",
													"NAME" => "Time",
												)
											);?>
										</div>
										<button class="btn-callback"><div class="callback pull-right" data-event="jqm" data-param-id="<?=CCache::$arIBlocks[SITE_ID]["aspro_allcorp_form"]["aspro_allcorp_callback"][0]?>" data-name="callback"><span><?=GetMessage("S_CALLBACK")?></span>
											</div></button>
									</div>
								...
								<? /* <div class="col-lg-3 col-md-4">
									<?$APPLICATION->IncludeComponent("aspro:social.info.allcorp", "corp", array(
										...
										"INSTAGRAM" => COption::GetOptionString("aspro.allcorp", "SOCIAL_INSTAGRAM", SITE_ID),
										"CACHE_TYPE" => "A",
										"CACHE_TIME" => "3600000",
										"CACHE_GROUPS" => "N"
										),
						...
						<div class="col-md-12">
							<div class="row">
								<?if($arTheme["MENU"] == "first"):?>
									<div class="col-md-1">
										<div class="logo"><?$APPLICATION->IncludeFile(SITE_DIR."include/logo.php", Array(), Array("MODE" => "php", "NAME" => "Logo"));?></div>
									</div>
									<div class="col-md-5 ws">
										<?$APPLICATION->IncludeComponent("bitrix:search.title", "corp", array(
										"NUM_CATEGORIES" => "1",
										"TOP_COUNT" => "5",
										"ORDER" => "date",
								...
								<?elseif($arTheme["MENU"] == "second"):?>
									...
									<div class="col-md-4">
										<div class="top-callback clearfix hidable">
											...
											<div class="callback pull-right" data-event="jqm" data-param-id="<?=CCache::$arIBlocks[SITE_ID]["aspro_allcorp_form"]["aspro_allcorp_callback"][0]?>" data-name="callback"><span><?=GetMessage("S_CALLBACK")?></span></div>
										</div>
										<button class="btn btn-responsive-nav" data-toggle="collapse" data-target=".nav-main-collapse">
											<i class="icon icon-bars"></i>
										</button>
	...
	array(
		...
		"PAGER_SHOW_ALL" => "N",
		"AJAX_OPTION_ADDITIONAL" => "",
		"COMPONENT_TEMPLATE" => "front-small-banners_custom",
		"SET_BROWSER_TITLE" => "Y",
		"SET_META_KEYWORDS" => "Y",
