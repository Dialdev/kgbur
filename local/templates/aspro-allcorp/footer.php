	...
	<div class="container maxwidth-theme">
		<div class="row">
			<?$APPLICATION->IncludeComponent(
				...
				Array(
					"AREA_FILE_SHOW" => "file",
					"PATH" => SITE_DIR."include/stages.php",
					"EDIT_TEMPLATE" => "standard.php"
				)
			);?>
		</div>
				...
				<div class="row">
					<div class="col-md-3">
						<div class="copy">
							...
							<div class="footer-developer dial_link">
				<a href="https://dialweb.ru/" class="footer-developer__link" target="_blank">
					Разработка сайта Digital Agency DIAL
				</a>
			</div>
						</div>
					</div>
					...
					<div class="col-md-3">
						<div class="info">
							...
							<div class="skype">
								...
								<?$APPLICATION->IncludeFile(SITE_DIR."include/site-address-footer.php", array(), array(
										"MODE" => "html",
										"NAME" => "Address",
									)
								);?>
