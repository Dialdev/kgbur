...
$arSections = CCache::CIBLockSection_GetList(array("SORT" => "ASC", "NAME" => "ASC", "CACHE" => array("TAG" => CCache::GetIBlockCacheTag($arParams["IBLOCK_ID"]), "GROUP" => array("ID"), "MULTI" => "N")), $arFilter, false, array("ID", "NAME", "DESCRIPTION"));
?>
<?if(!$arSections):?>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<?if($arSection["DESCRIPTION"]):?>
					<div class="text_before_items"><?=$arSection["DESCRIPTION"];?></div>
				<?endif;?>
				<?// section elements?>
