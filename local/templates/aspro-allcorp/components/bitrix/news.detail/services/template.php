	...
	<div class="ask_a_question">
				...
				<?if ($arResult["DISPLAY_PROPERTIES"]["PRICE"]["VALUE"]):?>
					<div class="services-price">
						от <span><?=$arResult["DISPLAY_PROPERTIES"]["PRICE"]["VALUE"]?></span> рублей 
					</div>
				<?endif?>
				<?if ($arResult["DISPLAY_PROPERTIES"]["PRICE_ALTERNATIVE"]["VALUE"]):?>
					<div class="services-price">
				 		<?=$arResult["DISPLAY_PROPERTIES"]["PRICE_ALTERNATIVE"]["VALUE"]?>  
					</div>
				<?endif?>
