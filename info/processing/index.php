...
$APPLICATION->SetPageProperty("description", "Политика конфиденциальности и соглашение на обработку персональных данных kgbur.ru (ООО «Контора Глубокого Бурения») содержит информацию о правилах использования сайта.");
$APPLICATION->SetTitle("Соглашение на обработку персональных данных");
?><p>
	 Данная политика конфиденциальности общества с ограниченной ответственностью «Контора Глубокого Бурения», ОГРН 1055005623738, относится к сайту под доменным именем <a href="https://kgbur.ru/">https://kgbur.ru/</a>. Эта страница содержит сведения о том, какую информацию мы (администрация сайта) или третьи лица могут получать, когда вы пользуетесь нашим сайтом.
</p>
<h2>
...
<p>
	 Если у вас есть какие-либо вопросы о политике конфиденциальности, использованию сайта или иным вопросам, связанным с сайтом, свяжитесь с нами: +7 (910) 526-87-94 или по электронной почте: <a href="mailto:kgbur@mail.ru">kgbur@mail.ru</a>.
